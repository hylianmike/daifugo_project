...
class LanGameController : Initializable
{
    private val deck = mutableListOf<Card>()

    private val player1Hand = mutableListOf<Card>()
    private val player2Hand = mutableListOf<Card>()
    private val dump1 = mutableListOf<Card>()
    private val dump2 = mutableListOf<Card>()
    ...
    private val playerHands = listOf(player1Hand, player2Hand)
    ...
    private fun endGame(event: ActionEvent) {
        ...
        controller.lanSetRankLabels(playerNames[winners[0]], playerNames[winners[1]])
